...
export function LikeButton({ id, likeLabel, likedLabel, liked }: Props): JSX.Element {
  return (
    <button id={id} type="button" className={styles.button} aria-label={liked ? likedLabel : likeLabel}>
      <span
        className={clsx({
          [styles.liked]: liked,
          [styles.like]: !liked,
